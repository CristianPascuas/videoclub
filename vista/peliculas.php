...
<main class="app-content">
    <div class="container-fluid py-4">
        <h1 class="h4 fw-semibold mb-3">Buscar Películas</h1>
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="search" class="form-control" placeholder="Buscar película, director, año, distribuidora..." id="buscarPelicula" name="buscarPelicula">
                        <button type="button" class="btn btn-primary" id="buscarPeliculaBtn">
...
<div class="modal fade" id="modalDetallePelicula" tabindex="-1" aria-labelledby="modalDetallePeliculaLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalDetallePeliculaLabel">Detalle de Película</h5>
